...
export const LOCALES = Object.freeze({
    ru: Object.freeze({
        ...
        calculator: Object.freeze({
            ...
            included: 'В базовом обследовании',
            standaloneFrom: 'Отдельный договор от {amount} сум/мес.',
            minimumTitle: 'Требуется другой формат обслуживания',
            minimumText: 'Для выбранного состава минимальный бюджет абонентского договора — {amount} сум/мес. При текущих параметрах автоматическое предложение не формируется.',
            minimumHelp: 'Можно пересмотреть состав обслуживания или обсудить разовый выезд. Если на небольшой площади много оборудования, инженер подготовит индивидуальный расчёт.',
            largeTitle: 'Индивидуальная программа объекта',
            largeText: 'Для площади свыше 50 000 м² показан только ориентир бюджета. Состав команды, регламент и стоимость согласовываются с инженером; автоматический документ не формируется.',
            reviewTitle: 'Стоимость после согласования программы',
            reviewText: 'Для расширенного обследования, большого количества оборудования или постоянного присутствия команды требуется индивидуальный расчёт.',
            blockedAction: 'Автоматический расчёт недоступен',
            expandSystems: 'Пересмотреть состав систем',
            switchAudit: 'Рассчитать базовое обследование',
            contactEngineer: 'Обсудить с инженером',
            reviewService: 'Много оборудования, особые условия или постоянная команда на объекте',
            reviewAudit: 'Нужен подробный аудит с полным реестром и инструментальными измерениями',
            reviewHint: 'Индивидуальная программа и стоимость после уточнения оборудования и задач.',
            selectionEmpty: 'Выберите системы',
            areaInvalid: 'Укажите площадь от 500 до 150 000 м².',
            auditCoverageTitle: 'Базовое техническое обследование',
            auditCoverageText: 'Осмотр доступного оборудования, изучение переданных документов, фотофиксация и структурированный отчёт. Сплошная инвентаризация и расширенные инструментальные измерения согласовываются отдельно.',
            auditExclusion: 'Слаботочные системы и СКУД временно не входят в аудит и расчёт стоимости.',
            ...
            pdfAuditSystems: 'Базовое обследование: кондиционирование, отопление, вентиляция, электроснабжение, водоснабжение и канализация.',
            pdfAuditNote: 'Базовое обследование. Слаботочные системы и СКУД исключены. Полная инвентаризация и расширенные измерения согласовываются отдельно.',
    ...
    uz: Object.freeze({
        ...
        calculator: Object.freeze({
            ...
            included: 'Bazaviy tekshiruvda',
            standaloneFrom: 'Alohida shartnoma oyiga {amount} so‘mdan',
            minimumTitle: 'Boshqa xizmat formati talab etiladi',
            minimumText: 'Tanlangan tarkib uchun abonent shartnomasining minimal byudjeti — oyiga {amount} so‘m. Joriy parametrlar bo‘yicha avtomatik taklif tuzilmaydi.',
            minimumHelp: 'Xizmat tarkibini qayta ko‘rib chiqish yoki bir martalik tashrifni muhokama qilish mumkin. Kichik maydonda uskunalar ko‘p bo‘lsa, muhandis individual hisob tayyorlaydi.',
            largeTitle: 'Obyekt uchun individual dastur',
            largeText: '50 000 m² dan katta obyekt uchun faqat taxminiy byudjet ko‘rsatiladi. Jamoa tarkibi, reglament va narx muhandis bilan kelishiladi; avtomatik hujjat yaratilmaydi.',
            reviewTitle: 'Narx dastur kelishilgandan so‘ng belgilanadi',
            reviewText: 'Batafsil tekshiruv, ko‘p sonli uskunalar yoki obyektdagi doimiy jamoa uchun individual hisob talab qilinadi.',
            blockedAction: 'Avtomatik hisob mavjud emas',
            expandSystems: 'Tizimlar tarkibini qayta ko‘rish',
            switchAudit: 'Bazaviy tekshiruvni hisoblash',
            contactEngineer: 'Muhandis bilan muhokama qilish',
            reviewService: 'Ko‘p uskunalar, maxsus shartlar yoki obyektdagi doimiy jamoa',
            reviewAudit: 'To‘liq reyestr va instrumental o‘lchovlar bilan batafsil audit kerak',
            reviewHint: 'Uskunalar va vazifalar aniqlangandan so‘ng individual dastur va narx.',
            selectionEmpty: 'Tizimlarni tanlang',
            areaInvalid: '500 dan 150 000 m² gacha maydon kiriting.',
            auditCoverageTitle: 'Bazaviy texnik tekshiruv',
            auditCoverageText: 'Mavjud uskunalarni ko‘zdan kechirish, taqdim etilgan hujjatlarni o‘rganish, fotofiksatsiya va tizimlashtirilgan hisobot. To‘liq inventarizatsiya va kengaytirilgan instrumental o‘lchovlar alohida kelishiladi.',
            auditExclusion: 'Past tok tizimlari va SKUD vaqtincha audit hamda narx hisobiga kirmaydi.',
            ...
            pdfAuditSystems: 'Bazaviy tekshiruv: konditsionerlash, isitish, ventilyatsiya, elektr ta’minoti, suv ta’minoti va kanalizatsiya.',
            pdfAuditNote: 'Bazaviy tekshiruv. Past tok tizimlari va SKUD kirmaydi. To‘liq inventarizatsiya va kengaytirilgan o‘lchovlar alohida kelishiladi.',
    ...
    en: Object.freeze({
        ...
        calculator: Object.freeze({
            ...
            included: 'Included in the base survey',
            standaloneFrom: 'Standalone contract from {amount} UZS/month',
            minimumTitle: 'A different service arrangement is required',
            minimumText: 'The minimum monthly budget for the selected scope is {amount} UZS. An automatic proposal is not available for the current parameters.',
            minimumHelp: 'You can reconsider the service scope or discuss a one-off visit. For a small facility with substantial equipment, an engineer will prepare an individual estimate.',
            largeTitle: 'An individual programme for your facility',
            largeText: 'For facilities above 50,000 m², the amount is a budget indication only. Staffing, maintenance schedules and pricing require engineering review; no automatic document is issued.',
            reviewTitle: 'Price confirmed after the programme is agreed',
            reviewText: 'A detailed survey, substantial equipment or an on-site team requires an individual estimate.',
            blockedAction: 'Automatic estimate unavailable',
            expandSystems: 'Reconsider the system scope',
            switchAudit: 'Estimate a base survey',
            contactEngineer: 'Discuss with an engineer',
            reviewService: 'Substantial equipment, special conditions or a permanent on-site team',
            reviewAudit: 'A detailed audit with a full inventory and instrumental measurements is required',
            reviewHint: 'An individual programme and price follow review of the equipment and requirements.',
            selectionEmpty: 'Select systems',
            areaInvalid: 'Enter an area between 500 and 150,000 m².',
            auditCoverageTitle: 'Base technical survey',
            auditCoverageText: 'Inspection of accessible equipment, review of supplied documents, photographic records and a structured report. A full inventory and extended instrumental measurements are agreed separately.',
            auditExclusion: 'Low-voltage and access-control systems are temporarily excluded from the audit and price calculation.',
            ...
            pdfAuditSystems: 'Base survey: air conditioning, heating, ventilation, electrical supply, water supply and drainage.',
            pdfAuditNote: 'Base survey. Low-voltage and access-control systems are excluded. Full inventory and extended measurements are agreed separately.',
